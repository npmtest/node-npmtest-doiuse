...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-doiuse/node_modules/doiuse/data/features.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-doiuse/node_modules/doiuse/data/features.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-doiuse/node_modules/doiuse/data/</a> &#187; features.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var list = require('postcss/lib/list')
var pats = {
  attrcc: '[^\\~|^$*\\]]*',
  brackets: /(\[[^\]]*\]|\([^\)]*\))/.source,
  nobrackets: /[^\[\]\(\)]/.source
...
function matchOutsideOfBrackets (pat) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (pat instanceof RegExp) {
    pat = pat.source
  }
...
<span class="cstat-no" title="statement not covered" >      return list.comma(value).length &gt; 1</span>
    }]
  },
  'css-table': {
    properties: ['display'],
