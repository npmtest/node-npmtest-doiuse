...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-doiuse/node_modules/doiuse/lib/missing-support.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-doiuse/node_modules/doiuse/lib/missing-support.js</span></h1>
    <h2>
        
        Statements: <span class="metric">97.78% <small>(44 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-doiuse/node_modules/doiuse/lib/</a> &#187; missing-support.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">17094</span>
<span class="cline-any cline-yes">17094</span>
<span class="cline-any cline-neutral">&nbsp;</span>
    ...
    var feature = _.reduce(versionData, function (result, support, ver) {
      ...
      if (selected) {
        ...
        if (!/(^|\s)y($|\s)/.test(support)) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!result[testprop]) {
<span class="cstat-no" title="statement not covered" >            result[testprop] = {};</span>
          }
